...
. watermark, do pitstop validation, do PDF/A transformation

Usually the result is a tar.gz archive, saved on the file system.
This archive contains a the compiled pdf, the original archive and the
...
svn co http://auriol/svn/misc/yakunin-project/with-script yakunin-project
cd yakunin-project
...
At the moment, tests are kept outside of the yakunin, package
